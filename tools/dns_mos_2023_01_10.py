...
python dns_mos_local_2023_01_10.py --testset_dir /path/to/dir -o /path/to/csv
"""
...
def main(args):
    ...
    if args.personalized_MOS:
        primary_model_path = (
            "/data/ssp/public/data/dns/dns_mos/pDNSMOS/sig_bak_ovr.onnx"
        )
    else:
        primary_model_path = "/data/ssp/public/data/dns/dns_mos/DNSMOS/sig_bak_ovr.onnx"
